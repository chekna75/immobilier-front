...
export const getUserGET = async (Constants, _args, handlers, timeout) => {
  const url = `https://example-data.draftbit.com/people/1`;
...
export const useGetUserGET = (
  ...
  return useQuery(
    ['exampleUserGetUserGET', args],
    () => getUserGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
      ...
      staleTime,
      onSuccess: () =>
        queryClient.invalidateQueries(['exampleUserGetUserGETS']),
    }
  );
};
