...
export const individualPropertyGET = async (
  Constants,
  { id },
  handlers,
  timeout
) => {
  const url = `https://example-data.draftbit.com/properties/${encodeQueryParam(
    id
  )}`;
...
export const useIndividualPropertyGET = (
  ...
  return useQuery(
    ...
    () => individualPropertyGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const listOfPropertiesGET = async (
  Constants,
  { limit },
  handlers,
  timeout
  ...
  const url = `https://example-data.draftbit.com/properties/${renderQueryString(
    paramsDict
  )}`;
  const controller = new AbortController();
  let timeoutObj;
...
export const useListOfPropertiesGET = (
  ...
  return useQuery(
    ...
    () => listOfPropertiesGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
